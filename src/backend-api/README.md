...
* Check the `ConnectionStrings` in `appsettings.json` files under the `Gdg.BasketApi` project and change it if you need.
...
* The application needs to connect to a database. Run the following command in the `Gdg.BasketApi` directory:
